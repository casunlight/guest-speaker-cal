...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { day_id: @speaker.day_id, lecture_description: @speaker.lecture_description, lecture_title: @speaker.lecture_title, name: @speaker.name }
    end
  ...
  test "should update speaker" do
    put :update, id: @speaker, speaker: { day_id: @speaker.day_id, lecture_description: @speaker.lecture_description, lecture_title: @speaker.lecture_title, name: @speaker.name }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
